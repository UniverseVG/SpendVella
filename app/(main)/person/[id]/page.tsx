...
import { ExpenseBetweenUser, User, UserType } from "@/types";
...
export default function PersonExpensesPage() {
  ...
  const { data, isLoading } = useConvexQuery(
    ...
    { userId: params.id }
  ) as { data: ExpenseBetweenUser | undefined; isLoading: boolean };
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-4 justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-4xl gradient gradient-title">{otherUser?.name}</h1>
      ...
      >
        ...
        <TabsContent value="expenses" className="space-y-4">
          <ExpenseList
            ...
            userLookupMap={
              { [otherUser?.id as string]: otherUser } as {
                [key: string]: UserType;
              }
            }
          />
