...
function ExpenseForm({
  ...
  const onSubmit = async (data: z.infer<typeof expenseSchema>) => {
    try {
      ...
      const formattedSplits = splits.map((split: SplitType) => ({
        userId: split.userId,
        amount: split.amount,
      ...
      const successId = type === "individual" ? otherUserId : groupId;

      if (onSuccess && typeof successId === "string") {
        onSuccess(successId);
      }
    } catch (error: any) {
          ...
          >
            ...
            <TabsContent value="equal" className="pt-4">
              ...
              <SplitSelector
                ...
                onSplitsChange={setSplits as (splits: SplitType[]) => void}
              />
            </TabsContent>
